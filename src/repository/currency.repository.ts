...
const getAllCurrencyService = async () => {
...
const getAllCurrencies = async (page: number = 1, limit: number = 20, search?: string, is_enabled?: boolean) => {
...
const updateCurrencyRate = async (currency: string, rate: number) => {
...
const updateCurrencyStatus = async (currency: string, is_enabled: boolean) => {
