...
const card = { backgroundColor: '#ffffff', border: '1px solid #e6ebf1', borderRadius: '8px', padding: '40px', textAlign: 'center' };
const h1 = { color: '#1f2937', fontSize: '24px', fontWeight: '600', margin: '0 0 20px' };
const text = { color: '#4b5563', fontSize: '16px', lineHeight: '24px', textAlign: 'left' };
...
const footer = { color: '#9ca3af', fontSize: '14px', lineHeight: '22px', textAlign: 'left' };
